    ...
    <div class="tab_contents">
        ...
        <div class="inner">
            <div class="button_box">
                ...
                <div class="fr">
                    <button type="button" class="btn btn_md btn_darkgray btn_outline" v-if="adminYn === '1' || checkUser(userId,'write')" @click="fn_noticeWrite">등록</button>
                    <button type="button" class="btn btn_md btn_darkgray btn_outline" v-if="adminYn === '1' || checkUser(userId,'unuse')" @click="fn_noticeDelete">삭제</button>
                    </div>
            </div>

            <!-- ibsheet -->
            <div class="ib_wrap"  :style="{height: 'calc(100vh - 350px)'}">
                <div id="noticeSheet" class="ibsheet_table" style="height: 100%;" />
            </div>
        </div>
        <file-download
            modal-title="파일 보기"
        ...
        <excel-download
            ...
            ref-id="NoticeSheet_ExcelDownload"
...
<script>
   ...
   import { NoticeList } from '@plugin/ibsheet/community/communitySheet'
        ...
        methods: {
            ...
            async fn_noticeList() {
                let payload = {
                    ...
                    'noticeType' : this.adminYn === '0' ? this.userType : '',
                    'showYn' : this.adminYn === '0' ? 'Y' : '',
                    'searchStartDt' : '',
                    'searchEndDt' : '',
                };
                ...
                const response = await API.community.selectNoticeList(payload);    
                ...
                let options = NoticeList.options;

                options.Events = {
                    onClick: this.fn_selectFile,
                    ondblclick : this.fn_noticeView,
            ...
            fn_selectFile(evtParam){
                ...
                if(evtParam.col == "fileYn" && evtParam.event.target.tagName == "BUTTON"){ 
                    ...
                    if(1 >= selectRow.fileCnt){
                        ...
                        const paylaod = {
                            fileConnectId: selectRow.noticeId,
                            fileType:      'Notice',
                        }
                        const options = {
                            headers: {
                        ...
                        this.fileConnectId = selectRow.noticeId;
            ...
            fn_exportExcel: function (sheet) {
                ...
                this.excelDownload.fileName  = `공지사항_${this.$moment().format('YYYYMMDD')}.xlsx`,  // file명 : 현재화면 페이지 _현재 날짜
