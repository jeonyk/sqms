    ...
    <div class="tab_contents">
        ...
        <div class="inner">
            ...
            <div class="ib_wrap"  :style="{height: 'calc(100vh - 350px)'}">
                <div id="qltyTstPArchiveSheet" class="ibsheet_table" style="height: 100%;" />
            </div>
            <!-- ibsheet -->
        </div>
        <file-download
        ...
        <excel-download
            ...
            ref-id="QltyTstPArchiveSheet_ExcelDownload"
...
<script>
   ...
   import { DataArchiveList } from '@plugin/ibsheet/community/communitySheet'
        ...
        methods: {
            ...
            async fn_dataArchiveList() {
                ...
                try {
                    ...
                    let options = DataArchiveList.options
            ...
            fn_dataArchiveWrite() {
                this.$router.push({ name: 'QltyTstPArchiveWrite' })
            },
            ...
            fn_exportExcel: function (sheet) {
                ...
                this.excelDownload.fileName  = `품질관리_시험계획서_${this.$moment().format('YYYYMMDD')}.xlsx`,  // file명 : 현재화면 페이지 _현재 날짜
