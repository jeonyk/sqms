        ...
        <div class="lnb_container on">
            <div class="tab_contents">
                <div class="inner type2">
                    <h2 class="sub_title" v-if="viewModifiState">자료실(품질입찰DB) 수정
                        <div class="fr">
                    ...
                    <h2 class="sub_title" v-else>자료실(품질입찰DB) 상세
                        <div class="fr">
                    ...
                    <div class="table_normal_list mt0">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><span :class="viewModifiState ? 'emp_red':''">자료구분</span></th>
                                    ...
                                    <th><span :class="viewModifiState ? 'emp_red':''">본부</span></th>
                                    <td v-if="viewModifiState">
                                ...
                                <tr>
                                    <th><span :class="viewModifiState ? 'emp_red':''">국가</span></th>
                                    <td v-if="viewModifiState">
                                    ...
                                    <th><span :class="viewModifiState ? 'emp_red':''">발생년도</span></th>
                                    <td v-if="viewModifiState">
                                ...
                                <tr>
                                    <th><span :class="viewModifiState ? 'emp_red':''">발주처</span></th>
                                ...
                                <tr>
                                    <th><span :class="viewModifiState ? 'emp_red':''">프로젝트</span></th>
                                    <td colspan="3" v-if="viewModifiState">
                ...
                try {
                    if(this.dataArchiveId){
                        ...
                        if(response.status == '200'){
                            ...
                            this.input['occurYearNm'] = this.input.occurYear+'년도';
