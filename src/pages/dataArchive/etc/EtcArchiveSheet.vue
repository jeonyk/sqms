    ...
    <div class="tab_contents">
        ...
        <div class="inner">
            ...
            <div class="ib_wrap"  :style="{height: 'calc(100vh - 350px)'}">
                <div id="etcArchiveSheet" class="ibsheet_table" style="height: 100%;" />
            </div>
        </div>
        <file-download
            modal-title="파일 보기"
        ...
        <excel-download
            ...
            ref-id="EtcArchiveSheet_ExcelDownload"
...
<script>
   ...
   export default {
        ...
        methods: {
            ...
            fn_dataArchiveWrite() {
                this.$router.push({ name: 'EtcArchiveWrite' })
            },
            ...
            fn_exportExcel: function (sheet) {
                ...
                this.excelDownload.fileName  = `참고자료_기타_${this.$moment().format('YYYYMMDD')}.xlsx`,  // file명 : 현재화면 페이지 _현재 날짜
