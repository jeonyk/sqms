    ...
    <div class="tab_contents">
        ...
        <div class="inner">
            ...
            <div class="ib_wrap"  :style="{height: 'calc(100vh - 350px)'}">
                <div id="qltySstArchiveSheet" class="ibsheet_table" style="height: 100%;" />
            </div>
        </div>
        <file-download
            modal-title="파일 보기"
        ...
        <excel-download
            ...
            ref-id="QltySstArchiveSheet_ExcelDownload"
...
<script>
   ...
   export default {
        ...
        methods: {
            ...
            fn_dataArchiveWrite() {
                this.$router.push({ name: 'QltySstArchiveWrite' })
            },
            ...
            fn_exportExcel: function (sheet) {
                ...
                this.excelDownload.fileName  = `참고자료_품질제도_${this.$moment().format('YYYYMMDD')}.xlsx`,  // file명 : 현재화면 페이지 _현재 날짜
