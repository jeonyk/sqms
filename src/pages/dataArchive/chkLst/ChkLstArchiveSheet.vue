    ...
    <div class="tab_contents">
        ...
        <div class="inner">
            ...
            <div class="ib_wrap"  :style="{height: 'calc(100vh - 350px)'}">
                <div id="chkLstArchiveSheet" class="ibsheet_table" style="height: 100%;" />
            </div>
        </div>
        <file-download
            modal-title="파일 보기"
        ...
        <excel-download
            ...
            ref-id="ChkLstArchiveSheet_ExcelDownload"
...
<script>
   ...
   import { DataArchiveQltyList } from '@plugin/ibsheet/community/communitySheet'
        ...
        methods: {
            ...
            async fn_dataArchiveList() {
                ...
                try {
                    ...
                    let options = DataArchiveQltyList.options
            ...
            fn_dataArchiveWrite() {
                this.$router.push({ name: 'ChkLstArchiveWrite' })
            },
            ...
            fn_exportExcel: function (sheet) {
                ...
                this.excelDownload.fileName  = `품질관리_CheckList_${this.$moment().format('YYYYMMDD')}.xlsx`,  // file명 : 현재화면 페이지 _현재 날짜
