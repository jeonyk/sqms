        ...
        <div class="lnb_container on">
            <div class="tab_contents">
                <div class="inner type2">
                    <h2 class="sub_title" v-if="viewModifiState">자료실(CheckList) 수정
                        <div class="fr">
                    ...
                    <h2 class="sub_title" v-else>자료실(CheckList) 상세
                        <div class="fr">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" v-if="viewModifiState">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" rowspan="2" v-if="viewModifiState">
   ...
   export default {
        ...
        mounted() {
            ...
            if(this.$route.params && this.$route.params.dataArchiveId){
                ...
                this.$router.push({ name: 'ChkLstArchiveSheet' })
            }
        },
        methods: {
