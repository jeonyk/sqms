<template>
    <div class="tab_contents">
        ...
        <excel-download
            ...
            ref-id="CstrHbArchiveSheet_ExcelDownload"
...
<script>
   ...
   export default {
        ...
        methods: {
            ...
            fn_dataArchiveWrite() {
                this.$router.push({ name: 'CstrHbArchiveWrite' })
            },
            ...
            fn_exportExcel: function (sheet) {
                ...
                this.excelDownload.fileName  = `참고자료_시공핸드북_${this.$moment().format('YYYYMMDD')}.xlsx`,  // file명 : 현재화면 페이지 _현재 날짜
