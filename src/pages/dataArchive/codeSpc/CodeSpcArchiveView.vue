        ...
        <div class="lnb_container on">
            <div class="tab_contents">
                <div class="inner type2">
                    <h2 class="sub_title" v-if="viewModifiState">자료실(Code & Spec. Requirement) 수정
                        <div class="fr">
                    ...
                    <h2 class="sub_title" v-else>자료실(Code & Spec. Requirement) 상세
                        <div class="fr">
                    ...
                    <div class="table_normal_list mt0">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><span :class="viewModifiState ? 'emp_red':''">Dicipline</span></th>
                                    ...
                                    <th><span :class="viewModifiState ? 'emp_red':''">Item</span></th>
                                    <td v-if="viewModifiState">
                                ...
                                <tr>
                                    <th><span :class="viewModifiState ? 'emp_red':''">Section</span></th>
                                    <td v-if="viewModifiState">
                                    ...
                                    <th><span :class="viewModifiState ? 'emp_red':''">Purpose</span></th>
                                    <td v-if="viewModifiState">
        ...
        methods: {
                ...
                if(response.status == '200'){
                    ...
                    if(subResponse.status == '200'){
                        if(subResponse.data.data){
                            ...
                            this.fn_selectChange('item');
                            this.fn_selectChange('section');
                        }
                    }
                }
            },
            ...
            fn_selectChange(type){
                if(type == 'item'){
                    ...
                    this.diciplineList.forEach(item => {
                        if(item.codeVal == this.input.dicipline){
                            this.itemList = item.masterCodeList;
                            item.masterCodeList.forEach(subItem => {
                                if(this.input.item == subItem.codeVal){
                                    this.sectionList = subItem.masterCodeList
