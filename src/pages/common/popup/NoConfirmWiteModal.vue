<template>
    <!-- CAR 신규등록 / 수정 -->
        <b-modal id="CarWrite" :title="viewTitle" size="xxl" :footer-bg-variant="footerBg" v-on:shown="setClear">
            <template #default>
                <div class="pop_container">
                    <div class="tab_contents">
                        ...
                        <div class="button_box pl20 pr20">
                            <div class="fr" v-show="popcurrentTab == 0">
                                ...
                                <button type="button" id="approvalDtlBtn" class="btn btn_md btn_darkgray btn_outline" @click="fnAprvDtl(chkAprvInfoIdData.aprvInfoId)" v-if="viewType !=='Punch' && noCnfmStatus !== 'REGT' && noCnfmStatus !== '' && ptnrId !== userId">결재보기</button>
                                ...
                                <button type="button" id="approvalBtn" :class="'btn btn_md btn_blue ' + approvalClass" @click="clickApproval()" v-if="viewType !=='Punch' && inUser === userId && checkUser(userId,'write') && noCnfmStatus === 'REGT'">결재상신</button>
                                <button type="button" id="approvalBtn" :class="'btn btn_md btn_blue ' + approvalClass" @click="fnNext('PRCS')" v-if="viewType ==='Punch' && inUser === userId && checkUser(userId,'write')">발송</button>
                            </div>
                            <!-- <div class="fr" v-show="popcurrentTab == 1 && ptnrId !== userId">
                                <button type="button" id="approvalDtlBtn" class="btn btn_md btn_darkgray btn_outline" @click="fnAprvDtl(chkAprvInfoIdData.aprvInfoId)" v-if="viewType !=='Punch' && noCnfmStatus !== 'REGT' && noCnfmStatus !== ''">결재보기</button>
                            </div> -->
                            <div class="fr" v-show="popcurrentTab == 1 && ptnrId === userId">
                            ...
                            <div class="fr" v-show="popcurrentTab == 2 && inUser === userId">
                                ...
                                <button type="button" id="approvalBtn" :class="'btn btn_md btn_blue ' + approvalClass2" @click="clickApproval()" v-if="cnfmYn !== 'N' && viewType !=='Punch' && checkUser(userId,'write') && noCnfmStatus === 'CHCK'">결재상신</button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- <Datepicker ref="datapicker" v-on:value-change="dateChange" v-model="closeDt"/> -->
                                                </td>
                                            </tr>                                            
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <LstImg v-bind:lst-file-rst="lstImgRst"
                                                        ...
                                                        downloadable
                                                        :file-type="'noConfirmWriteQltyPicturePop'"
                                                    />
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <LstImg v-bind:lst-file-rst="lstImgRst2"
                                                        ...
                                                        :file-type="'noConfirmWriteQltyPicturePop2'"
                                                    />
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <approval-view
                        ref-id="NoConfirm_AprvView"
                        :aprv-info-id="chkAprvInfoIdData.aprvInfoId"
                        file-type="NCFM"
                    />
                </div>
            </template>
    ...
    export default {
        ...
        methods : {
                    ...
                    if(param2.noCnfmInfoId !== '' && param2.noCnfmInfoId !== null && param2.noCnfmInfoId !== undefined) {
                        ...
                        if(data.data === '0000') {
                            if(this.noCnfmStatus === 'REGT') {
                                ...
                                //이미지 저장
                                // console.log(this.copiedFileIds);
                                // console.log(this.copiesFileIds2);
                                ...
                                //이미지 저장
                                if((this.img2 != '' && typeof(this.img2) != 'undefined')||(this.copiedFileIds2 && this.copiedFileIds2.length>0)){
                                    requestFileOptions.headers['Accept-Language'] = "ko";
                                    requestFileOptions.headers['Authorization'] = this.$cookies.get("Authorization");
                                    this.fileConnectId2 = this.noCnfmInfoId2;
                                    try{
                        ...
                        try {
                            ...
                            if(data.data == "0000" && data.resultData.noCnfmInfoId != "") {
                                ...
                                if(this.img != '' && typeof(this.img) != 'undefined'){
                                    ...
                                    this.fileConnectId = data.resultData.noCnfmInfoId;
                                    try{
                                        const res_data3 = await sendFileApi(this.fileConnectId, "NoConfirmMngtImg", this.img).then((result) => {
                                        return result.data;
                                        }).catch((e) => {
                                            console.error(e.response.data);
                                            return e.response.data;
            ...
            async fn_sendMsg(msgParam) {
                ...
                msgParam['siteMstrId'] = this.$store.getters['auth/getSiteMstrId'];
                try {
            ...
            checkWriteVal : function() {
                ...
                if(this.img.length === 0 && this.lstImgRst.length === 0 && this.copiedFileIds.length === 0) {
            ...
            checkReturnVal : function() {
                ...
                if(this.lstImgRst2.length === 0 && this.img2.length === 0 && this.copiedFileIds2.length === 0) {
            ...
            checkFinalVal : function() {
                if(this.cnfmYn == null || this.cnfmYn == '') {
                    this.alert("합격여부를 선택해주세요.");
                    return false;
                }
            ...
            closeModal : function() {
                if(this.noCnfmStatus === '' && this.noCfrmType === 'write') {
                    this.confirm('작성중인 내용이 있습니다. 취소하시겠습니까?', ()=> {
                        this.$root.$emit('bv::hide::modal', 'CarWrite');
                        this.closeClear();
                        this.$emit('sheet-create', true);
                        this.$bvModal.hide('CarWrite')
                    })
                } else {
                    this.$root.$emit('bv::hide::modal', 'CarWrite');
                    this.closeClear();
