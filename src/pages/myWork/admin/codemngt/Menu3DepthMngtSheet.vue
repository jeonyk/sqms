    ...
    <div>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form_control size_md" v-model="search.midCodeId">
                                <option value="" > {{ '전체' }} </option>
                                <option v-for="item in searchMidCombo.filter(item => item.upperMenuMngtId === search.mainCodeId)" :key="item.menuNmKr" :value="item.menuMngtId">{{ item.menuNmKr }}</option>
                            </select>
                        </td>
                        <th>메뉴명</th>
                        <td>
        ...
        <div class="inner">
            ...
            <div class="ib_wrap mt0" style="height: calc(100vh - 320px)">
                <div id="ibsheet_menu3Depth" class="ibsheet_table" style="height: 100%;"></div>
            </div>
    ...
    export default {
        ...
        methods: {
            getCategoryData : async function () {
                ...
                await sendPostApi(url, param)
                        .then((data) => {
                            ...
                            this.searchMidCombo    = data.data.datas.dl2DepthMenu;
                            this.mainCombo      = data.data.datas.dl1DepthMenu;
                            this.midCombo       = data.data.datas.dl2DepthMenu;
            ...
            initSetGrid : function () {
                ...
                let menuOptions = menu3DepthSheet.options;
