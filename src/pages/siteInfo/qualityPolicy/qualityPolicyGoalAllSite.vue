            ...
            <div class="table_normal_list table_write">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <th>목표</th>
                            <td colspan="2"><input type="text" class="form_control" v-model="detail.goal"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan="2" class="al">
                                <textarea name="" id="" cols="30" rows="10" class="form_control" v-model="detail.metrics"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th rowspan="2"><span class="emp_red">현재수준</span></th>
                        ...
                        <tr>
                            <td><textarea name="" id="" cols="30" rows="10" class="form_control" v-model="detail.crntLevel"></textarea></td>
                            <td><textarea name="" id="" cols="30" rows="10" class="form_control" v-model="detail.nextLevel"></textarea></td>
                            <td><textarea name="" id="" cols="30" rows="10" class="form_control" v-model="detail.endLevel"></textarea></td>
                        </tr>
                        <tr>
                            <th><span class="emp_red">달성효과</span></th>
                            <td colspan="2"><textarea name="" id="" cols="30" rows="10" class="form_control" v-model="detail.achvImpt"></textarea></td>
                        </tr>
                        <tr>
                            <th><span class="emp_red">모니터링 주기/방법</span></th>
                            <td colspan="2"><input type="text" class="form_control" v-model="detail.mntrMethod"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="table_normal_list table_write">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <th>1분기</th>
                            <td><input type="text" class="form_control" v-model="detail.rst1"></td>
                        </tr>
                        <tr>
                            <th>2분기</th>
                            <td><input type="text" class="form_control" v-model="detail.rst2"></td>
                        </tr>
                        <tr>
                            <th>3분기</th>
                            <td><input type="text" class="form_control" v-model="detail.rst3"></td>
                        </tr>
                        <tr>
                            <th>4분기</th>
                            <td><input type="text" class="form_control" v-model="detail.rst4"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    export default {
                ...
                planData : {
                    options: {
                        ...
                        Cols: [
                            ...
                            { Name: 'actnPlan', Header: [{ Value: '실행계획' }], RelWidth: 25 },
                            { Name: 'prmtTerm', Header: [{ Value: '추진기간' }], RelWidth: 10 },
        ...
        mounted() {
            ...
            if(this.goal.writeYn){
                ...
                if(this.detail['fileList'].length>0){
                    let inputFileSize = 0;
        ...
        methods: {
            ...
            saveChange: async function(){
                ...
                // console.log(goalRst);
                if(goalRst.data.rCode == '0000' && goalRst.data.datas.cnt == rows.length){
                    ...
                    this.alert('저장되었습니다.',this.cancelEdit());
                    return;
                }else{
                    this.alert('저장에 실패했습니다.',);
                    return;
