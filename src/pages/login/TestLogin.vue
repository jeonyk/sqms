        ...
        <div class="login">
            ...
            <div class="info_area">
                ...
                <div class="user_input"> 
                    ...
                    <input type="password" class="form_control" :placeholder="$t('login.pw')" v-model.trim="userPw" v-on:keyup.enter="fn_login">
                    <div class="clearfix">
            ...
            <template #default>
                <div class="pop_container">
                     ...
                     <div class="input_number">
                         ...
                         <input id="form_num" type="text" class="form_control" v-model.trim="certNum">
                ...
                <b-button class="btn btn_lg btn_outline btn_gray mr30" @click="certNumSend()" v-show="TimeCounter===0">{{$t('login.reSend')}}</b-button>
