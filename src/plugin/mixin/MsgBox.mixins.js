...
export default Vue.extend({
  methods: {
    ...
    confirm (msg, callBack, cancelCallBack) {
      this.$bvModal.msgBoxConfirm(this.msgBoxContents(msg), {...this.msgBoxOptions, footerClass: 'modal-msg-box-footer modal-msg-box-footer-reverse'})
        .then(value => {
